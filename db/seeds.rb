...
Movie.all.each do |movie|
  filename = movie.title.parameterize + ".png"
  File.open(Rails.root + "app/assets/images/#{filename}", "r") do |f|
    movie.main_image.attach(io: f, filename: filename)
  end
end
User.create!([
  {
...
fav1 = User.first.favorites.create!(movie: Movie.first)
fav2 = User.first.favorites.create!(movie: Movie.last)
fav3 = User.second.favorites.create!(movie: Movie.second)
fav4 = User.second.favorites.create!(movie: Movie.third)
fav5 = User.last.favorites.create!(movie: Movie.first)
fav6 = User.last.favorites.create!(movie: Movie.last)
